...
import { VStack, HStack, Box } from '@cbhq/cds-mobile/layout';
import { TabbedChips } from '@cbhq/cds-mobile/alpha/tabbed-chips/TabbedChips';
import { PortalProvider } from '@cbhq/cds-mobile/overlays/PortalProvider';
import { StatusBar, ThemeProvider } from '@cbhq/cds-mobile/system';
...
export default function App() {
  ...
  const [fontsLoaded] = useFonts({
    CoinbaseIcons: require('@cbhq/cds-icons/fonts/native/CoinbaseIcons.ttf'),
    Inter_400Regular,
    Inter_600SemiBold,
  });
