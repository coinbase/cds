...
```sh
npx --package=@cbhq/cds-mcp-server cds-mcp-setup
```

After running the setup command, enable the MCP server in your editor. See the [CDS AI Overview](https://cds.cbhq.net/getting-started/ai-overview#first-time-setup) for full setup instructions.
