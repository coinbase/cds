...
import { Select } from '@cbhq/cds-web/alpha/select'; // or '@cbhq/cds-mobile/alpha/select'
import { VStack } from '@cbhq/cds-web/layout'; // or '@cbhq/cds-mobile/layout'
...
```tsx
import { ContentCell } from '@cbhq/cds-web/cells'; // or '@cbhq/cds-mobile/cells'
import { Avatar } from '@cbhq/cds-web/media'; // or '@cbhq/cds-mobile/media'
...
```tsx
import { Carousel } from '@cbhq/cds-web/carousel'; // or '@cbhq/cds-mobile/carousel'
