<!--
Vendored verbatim from AOSP. Do not edit or reformat this file; re-download it instead:

  curl -sfL https://raw.githubusercontent.com/androidx/androidx/androidx-main/compose/docs/compose-api-guidelines.md \
    -o .claude/skills/jetpack-best-practices/references/compose-api-guidelines.md

Source:  https://android.googlesource.com/platform/frameworks/support/+/androidx-main/compose/docs/compose-api-guidelines.md
Mirror:  https://github.com/androidx/androidx/blob/androidx-main/compose/docs/compose-api-guidelines.md
License: Apache License 2.0, Copyright The Android Open Source Project
-->
