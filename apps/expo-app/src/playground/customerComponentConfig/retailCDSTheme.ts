...
export const retailCDSTheme: ThemeConfig = {
  ...coinbaseTheme,
  id: retailCDSThemeId,
  lightSpectrum,
  darkSpectrum,
  lightColor: {
    ...coinbaseTheme.lightColor,
