...
const PACKAGES: PackageConfig[] = [
  { packageName: '@cbhq/cds-web', packageDir: 'packages/web' },
  { packageName: '@cbhq/cds-mobile', packageDir: 'packages/mobile' },
  { packageName: '@cbhq/cds-web-visualization', packageDir: 'packages/web-visualization' },
  {
    packageName: '@cbhq/cds-mobile-visualization',
