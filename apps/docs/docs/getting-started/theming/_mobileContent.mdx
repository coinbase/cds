...
[See the `ThemeConfig` type definition here &rarr;](https://github.com/coinbase/cds-staging/blob/master/packages/mobile/src/core/theme.ts#L11)

[See the `Theme` type definition here &rarr;](https://github.com/coinbase/cds-staging/blob/master/packages/mobile/src/core/theme.ts#L50)
...
[See the `defaultTheme` source code here &rarr;](https://github.com/coinbase/cds-staging/blob/master/packages/mobile/src/themes/defaultTheme.ts)
...
The `ThemeVars` namespace contains type definitions for all themeable variable namess in CDS. It includes any custom theme variables added in `ThemeVarsExtended`.
