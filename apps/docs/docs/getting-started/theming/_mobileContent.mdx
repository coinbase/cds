...
import { ComponentConfigProvider } from '@cbhq/cds-mobile/system/ComponentConfigProvider';
...
import type { ComponentConfig } from '@cbhq/cds-mobile/core/componentConfig';
import { Button } from '@cbhq/cds-mobile/buttons/Button';
import { ComponentConfigProvider } from '@cbhq/cds-mobile/system/ComponentConfigProvider';
