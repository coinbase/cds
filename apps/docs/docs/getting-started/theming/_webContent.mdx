...
import { createThemeCssVars } from '@cbhq/cds-web/core/createThemeCssVars';
...
[See the `ThemeConfig` type definition here &rarr;](https://github.com/coinbase/cds-staging/blob/master/packages/web/src/core/theme.ts#L4)

[See the `Theme` type definition here &rarr;](https://github.com/coinbase/cds-staging/blob/master/packages/web/src/core/theme.ts#L43)
...
[See the `defaultTheme` source code here &rarr;](https://github.com/coinbase/cds-staging/blob/master/packages/web/src/themes/defaultTheme.ts)
