...
CDS provides a comprehensive index of documentation in markdown format for AI tools:
...
Other AI IDEs and assistants (like Claude Code, Windsurf, etc.) have similar functionality for adding documentation indexes.
