...
:::tip
The `cds-docs` skill works great alongside the CDS MCP Server for the best AI-assisted development experience, but it can also be used independently of the MCP server.
:::
