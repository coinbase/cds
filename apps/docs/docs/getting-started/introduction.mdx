...
<ContentHeader
  title="Introduction"
  description="CDS is a cross-platform component library designed to streamline the development of React and React Native applications. It empowers developers with consistent, reusable, and accessible components that adhere to Coinbase's engineering principles."
