...
DatePicker supports the same styling functionality as [DateInput](/components/other/DateInput/) for the input (`styles.dateInput`) plus [Calendar](/components/other/Calendar/) slots via `styles.calendar`.
