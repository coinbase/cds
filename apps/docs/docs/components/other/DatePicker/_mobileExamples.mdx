...
DatePicker supports the same styling functionality as [DateInput](/components/other/DateInput/) plus [Calendar](/components/other/Calendar/) via `styles.calendar`.
