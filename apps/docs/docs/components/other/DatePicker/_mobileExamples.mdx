...
DatePicker supports the same styling functionality as [DateInput](/components/other/DateInput/) plus root-level styling for the [Calendar](/components/other/Calendar/).
