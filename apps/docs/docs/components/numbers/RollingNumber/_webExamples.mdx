...
function CountDownExample() {
  ...
  return (
    <VStack gap={1}>
      ...
      <HStack gap={2}>
        <Button alignSelf="flex-start" onClick={() => setRunning((r) => !r)}>
          {running ? 'Pause' : 'Start'}
        </Button>
        <Button alignSelf="flex-start" onClick={onReset}>
          Reset
        </Button>
      </HStack>
...
function LiveBiddingExample() {
  ...
  return (
    <VStack gap={2}>
      ...
      <HStack gap={1}>
        <Button alignSelf="flex-start" onClick={() => placeBid(100)}>
          +$100
        </Button>
        <Button alignSelf="flex-start" onClick={() => placeBid(500)}>
          +$500
        </Button>
        <Button alignSelf="flex-start" onClick={() => placeBid(1000)}>
          +$1000
        </Button>
      </HStack>
    </VStack>
