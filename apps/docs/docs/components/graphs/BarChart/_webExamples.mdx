...
function Candlesticks() {
  ...
  const BandwidthReferenceLine = memo<ReferenceLineProps>((props) => (
    <ReferenceLine {...props} LineComponent={BandwidthHighlight} />
  ));
  ...
  return (
    <VStack gap={2}>
      ...
      >
        <Scrubber
          hideOverlay
          LineComponent={BandwidthReferenceLine}
          seriesIds={[]}
        />
      </BarChart>
    </VStack>
...
You can customize the transition animations for your bar chart using the `transitionConfigs` prop.
...
function UpdatingChartValues() {
  ...
  return (
    <VStack gap={2}>
      ...
      <Text font="label">Custom Enter + Update Animations</Text>
      <BarChart
        height={150}
        series={[
          {
        ...
        transitionConfigs={{
          enter: { type: 'spring', duration: 1.5, bounce: 0.2 },
          update: { type: 'tween', duration: 0.3, ease: 'easeOut' },
        }}
        showXAxis
        showYAxis
        xAxis={{
