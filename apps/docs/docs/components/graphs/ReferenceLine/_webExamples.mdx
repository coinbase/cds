...
Talk about dataX vs dataY

## Label

Todo, talk about label, showcase a few examples of left and right with even bold text

## Customization

### Line

Talk about adjusting the line color, stroke, type, etc.
