...
function BandGridPlacement() {
  const bandGridPlacements = [
    { id: 'edges', label: 'Edges' },
    { id: 'start', label: 'Start' },
    { id: 'middle', label: 'Middle' },
    { id: 'end', label: 'End' },
  ];
  const [selectedBandGridPlacement, setSelectedBandGridPlacement] = useState(bandGridPlacements[0]);
  ...
  return (
    <VStack gap={2}>
      ...
      >
        <XAxis
          bandGridPlacement={selectedBandGridPlacement.id}
