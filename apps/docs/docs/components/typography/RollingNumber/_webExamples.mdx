...
<VStack gap={2}>
  ...
  <RollingNumber as="h1" value={12345.67} format={{ style: 'currency', currency: 'USD' }} />
  <RollingNumber as="p" value={12345.67} format={{ style: 'currency', currency: 'USD' }} />
</VStack>
```
