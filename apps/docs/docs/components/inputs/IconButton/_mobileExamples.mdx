...
<HStack alignItems="center" flexWrap="wrap" gap={2}>
  <IconButton accessibilityLabel="Settings (xs)" name="gear" onPress={console.log} size="xs" />
  <IconButton accessibilityLabel="Settings (s)" name="gear" onPress={console.log} size="s" />
  <IconButton accessibilityLabel="Settings (m)" name="gear" onPress={console.log} size="m" />
  <IconButton accessibilityLabel="Settings (l)" name="gear" onPress={console.log} size="l" />
</HStack>
```
