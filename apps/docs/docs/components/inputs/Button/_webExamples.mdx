...
```jsx live
<HStack gap={2} flexWrap="wrap">
  <Button onClick={console.log} endIcon="forwardArrow" size="s" variant="secondary">
    See more
  </Button>
  <Button onClick={console.log} endIcon="externalLink" size="s" variant="secondary">
    Open link
  </Button>
</HStack>
```
...
```jsx live
<HStack gap={2} flexWrap="wrap">
  <Button onClick={console.log} size="s" startIcon="add" startIconActive variant="secondary">
    Add item
  </Button>
  <Button onClick={console.log} size="s" startIcon="download" variant="secondary">
    Download
  </Button>
</HStack>
```
