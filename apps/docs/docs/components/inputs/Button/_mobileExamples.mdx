...
```jsx
<HStack gap={2}>
  <Button onPress={console.log} endIcon="forwardArrow" variant="secondary" size="s">
    See more
  </Button>
  <Button onPress={console.log} endIcon="externalLink" variant="secondary" size="s">
    Open link
  </Button>
</HStack>
```
...
```jsx
<HStack gap={2}>
  <Button onPress={console.log} startIcon="add" startIconActive variant="secondary" size="s">
    Add item
  </Button>
  <Button onPress={console.log} startIcon="download" variant="secondary" size="s">
    Download
  </Button>
</HStack>
```
