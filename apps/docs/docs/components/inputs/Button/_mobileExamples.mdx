...
`size` accepts `xs`, `s`, `m`, and `l`. Defaults to `l`.
...
```jsx
<HStack gap={2}>
  <Button onPress={console.log} endIcon="forwardArrow" size="s" variant="secondary">
    See more
  </Button>
  <Button onPress={console.log} endIcon="externalLink" size="s" variant="secondary">
    Open link
  </Button>
</HStack>
```
...
```jsx
<HStack gap={2}>
  <Button onPress={console.log} size="s" startIcon="add" startIconActive variant="secondary">
    Add item
  </Button>
  <Button onPress={console.log} size="s" startIcon="download" variant="secondary">
    Download
  </Button>
</HStack>
```
