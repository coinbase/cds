  ...
  <MessagingCard
    ...
    media={
      <RemoteImage
        ...
        resizeMode="cover"
        shape="rectangle"
        source={{ uri: 'https://cds.cbhq.net/img/feature.png' }}
      />
    }
    mediaPlacement="end"
  />
...
function CommunityUpsell() {
  const { spectrum } = useTheme();
  const cards = [
    { bg: `rgb(${spectrum.teal70})`, image: 'https://cds.cbhq.net/img/community.png' },
    { bg: `rgb(${spectrum.purple70})`, image: 'https://cds.cbhq.net/img/radial.png' },
  ];
  return (
    <VStack gap={2}>
      {cards.map((card, i) => (
  ...
  const cards = [
    {
      ...
      bg: `rgb(${spectrum.blue80})`,
      image: 'https://cds.cbhq.net/img/marketing.png',
    },
    {
      title: 'Coinbase Card',
      ...
      image: 'https://cds.cbhq.net/img/object.png',
    },
  ];
  return (
    <VStack gap={2}>
        ...
        <MessagingCard
          ...
          media={
            <RemoteImage
              ...
              resizeMode="cover"
              shape="rectangle"
              source={{ uri: 'https://cds.cbhq.net/img/place.png' }}
            />
          }
          mediaPlacement="end"
          onDismissButtonPress={() => {}}
      ...
      <MessagingCard
        ...
        media={
          <RemoteImage
            ...
            resizeMode="cover"
            shape="rectangle"
            source={{ uri: 'https://cds.cbhq.net/img/community.png' }}
          />
        }
        mediaPlacement="end"
  ...
  <MessagingCard
    ...
    media={
      <RemoteImage
        ...
        resizeMode="cover"
        shape="rectangle"
        source={{ uri: 'https://cds.cbhq.net/img/marketing.png' }}
      />
    }
    mediaPlacement="end"
  />
            ...
            media={
              card.type === 'upsell' ? (
                <RemoteImage
                  ...
                  resizeMode="cover"
                  shape="rectangle"
                  source={{ uri: 'https://cds.cbhq.net/img/object.png' }}
                  width={80}
                />
              ) : (
  ...
  <MessagingCard
    ...
    media={
      <RemoteImage
        ...
        resizeMode="cover"
        shape="rectangle"
        source={{ uri: 'https://cds.cbhq.net/img/collection.png' }}
      />
    }
    mediaPlacement="end"
  />
        ...
        <MessagingCard
          ...
          media={
            <RemoteImage
              ...
              resizeMode="cover"
              shape="rectangle"
              source={{ uri: 'https://cds.cbhq.net/img/radial.png' }}
            />
          }
          mediaPlacement="end"
        />
