...
import webPropsToc from ':docgen/web/cards/MessagingCard/MessagingCard/toc-props';
import mobilePropsToc from ':docgen/mobile/cards/MessagingCard/MessagingCard/toc-props';
