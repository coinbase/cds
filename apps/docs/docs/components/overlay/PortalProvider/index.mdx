...
<VStack gap={5}>
  <ComponentHeader
    ...
    description="A required root-level provider that enables CDS overlay components (Modal, Toast, Alert, Tooltip, Tray). Must be rendered once near the root of your application, alongside ThemeProvider."
  />
