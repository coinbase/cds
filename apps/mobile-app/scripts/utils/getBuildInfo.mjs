...
const APP_NAME = 'mobileapp';
const IOS_SCHEME = 'mobileapp';
const IOS_BUNDLE_ID = 'com.anonymous.mobile-app';
const ANDROID_PACKAGE_ID = 'com.anonymous.mobileapp';
...
export function getBuildInfo({ platform, profile, target = 'simulator' }) {
  ...
  const ios = {
    ...
    workspace: path.resolve('ios', 'mobileapp.xcworkspace'),
    isDevice,
