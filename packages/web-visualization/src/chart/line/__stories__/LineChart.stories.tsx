...
import { Avatar, RemoteImage } from '@cbhq/cds-web/media';
import { RollingNumber } from '@cbhq/cds-web/numbers';
...
} from '@cbhq/cds-web/tabs';
import { Text, TextLabel1 } from '@cbhq/cds-web/typography';
