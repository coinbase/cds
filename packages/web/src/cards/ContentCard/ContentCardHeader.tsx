...
export type ContentCardHeaderBaseProps = Polymorphic.ExtendableProps<
  BoxBaseProps,
  SharedProps & {
    /** @deprecated Use `thumbnail` instead. `avatar` will be removed in a future major release. Targeting removal in v9. */
    ...
    /** @deprecated Use `subtitle` instead. `meta` will be removed in a future major release. Targeting removal in v9. */
    meta?: React.ReactNode;
    /** Text or React node to display as the header subtitle. Use a Text component to override default color and font. */
    subtitle?: React.ReactNode;
    /** @deprecated Use `actions` instead. `end` will be removed in a future major release. Targeting removal in v9. */
    end?: React.ReactNode;
