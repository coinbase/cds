...
export default {
  ...
  ${showArea ? 'showArea' : ''}
  series={[
    { id: 'series-1', data: [10, 45, 30, 70, 55] },${isDoubleLine || isTripleLine ? figma.code`
    { id: 'series-2', data: [20, 35, 50, 40, 65] },` : hasForecast ? figma.code`
    { id: 'prediction', data: [55, 65, 75, 85, 95], type: 'dotted' },` : ''}${isTripleLine ? figma.code`
