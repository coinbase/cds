...
type CellMediaOtherProps = {
  ...
  /**
   * @deprecated This prop will be removed in v6.0.0. This will be removed in a future major release.
...
/**
 * @deprecated This component will be removed in a future release. Pass media directly via the `media` prop. This will be removed in a future major release.
 * @deprecationExpectedRemoval v9
