...
- Fix: improve button text alignment by using flexbox. [[#720](https://github.com/coinbase/cds/pull/720)]
...
<sub>Release entries above are generated by `nx release` from version plans. See the [NPM registry](https://www.npmjs.com/package/@coinbase/cds-web) for published versions. `@coinbase/cds-web` adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).</sub>
