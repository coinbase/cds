...
const descriptionMap: Record<string, string[]> = {
  ...
  asset: ['bigBtc', 'sendCryptoFaster', 'tradeImmediately', 'leadingProtocol'],
  sparkles: ['bigBtc', 'downloadingStatement', 'primeStaking'],
  stars: ['bigBtc', 'ethWrappedStakingRewards', 'ethStakingRewards', 'usdcLoan', 'concierge'],
  '✨': [
    'bigBtc',
    'ratMigration',
    'primeEarn',
  ...
  safe: ['fiatInterest', 'secureAndTrusted', 'coinbaseOneSavingFunds'],
  funds: [
    'fiatInterest',
    'portfolioOverview',
    'coinbaseOneSavingFunds',
