...
const descriptionMap: Record<string, string[]> = {
  ...
  shield: ['instoCoinbaseOneProtectedCrypto', 'coinbaseOneProtectedCrypto', 'secureAndTrusted'],
  protect: [
    'instoCoinbaseOneProtectedCrypto',
    'coinbaseOneProtectedCrypto',
  ...
  would: ['instoStakingMissedReturns', 'stakingMissedReturns', 'stakingMissedReturnsUsdc'],
  have: ['instoStakingMissedReturns', 'stakingMissedReturns', 'stakingMissedReturnsUsdc'],
  missed: ['instoStakingMissedReturns', 'stakingMissedReturns', 'stakingMissedReturnsUsdc'],
  out: ['instoStakingMissedReturns', 'stakingMissedReturns', 'stakingMissedReturnsUsdc'],
  on: [
    'instoStakingMissedReturns',
    'onTheList',
    'stakingMissedReturns',
  ...
  grow: ['instoStakingMissedReturns', 'stakingMissedReturns', 'stakingMissedReturnsUsdc'],
  '': [
    'instoRequestSent',
    'instoKeyGenerationComplete',
    'instoOnChain',
  ...
  key: ['instoPrivateKey', 'unlockKey', 'privateKey'],
  network: [
    'instoPrivateKey',
    'referralsBitcoin',
  ...
  encrypted: ['instoPrivateKey', 'encryptedEverything', 'privateKey'],
  acces: ['instoPrivateKey', 'privateKey'],
  Documents: ['instoDocumentSuccess', 'documentSuccess', 'idVerificationSecure'],
  ...
  complete: ['instoDocumentSuccess', 'completeAQuiz', 'documentSuccess'],
  '✅': [
    'instoDocumentSuccess',
    'verifyEmail',
    'documentSuccess',
  ...
  email: ['instoOpenEmail', 'verifyEmail', 'emailNotification', 'openEmail'],
  ...
  convert: ['usdtToUSDC', 'realToUSDC', 'cbbtc', 'cbxrp', 'cbltc', 'cbdoge', 'cbada', 'flipStable'],
  ...
  ccoin: ['cbbtc'],
  cbbtc: ['cbbtc'],
  conversion: ['cbbtc', 'cbxrp', 'cbltc', 'cbdoge', 'cbada', 'flipStable'],
