...
const descriptionMap: Record<string, string[]> = {
  ...
  success: ['success', 'readyToTrade', 'documentSuccess', 'rocket', 'walletConfirmation'],
  positive: ['success', 'rocket', 'faceMatchReal', 'private', 'walletConfirmation'],
  ...
  Coin: ['coinsInWallet', 'primeEarn', 'bigBtc', 'primeDeFi', 'coinFifty'],
