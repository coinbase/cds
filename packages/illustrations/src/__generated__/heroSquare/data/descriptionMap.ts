...
const descriptionMap: Record<string, string[]> = {
  ...
  One: ['usdAndUsdc', 'referralsCoinbaseOne', 'coinbaseOneUSDCBig', 'coinbaseOneAirdrop'],
  cb1: [
    'usdAndUsdc',
    'coinbaseOneLogo',
    'selectReward',
  ...
  usdc: ['usdAndUsdc', 'coinbaseOneUSDCBig', 'usdtToUSDC', 'realToUSDC'],
  ...
  both: ['usdAndUsdc', 'whyNotBoth', 'coinbaseOneUSDCBig'],
  user: [
    'usdAndUsdc',
