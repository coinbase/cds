...
const descriptionMap: Record<string, string[]> = {
  ...
  ada: ['cbhype', 'cbzec', 'cbada'],
  cbada: ['cbhype', 'cbzec', 'cbada'],
  leverage: [
    'leverage',
  ...
  Hold: ['holdingCrypto'],
  down: ['holdingCrypto', 'coinbaseIsDown', 'coinbaseIsDownMobile', 'arrowsUpDown'],
  ...
  law: ['stableValue'],
  stable: ['stableValue', 'usdtToUSDC', 'stablecoin', 'realToUSDC', 'usdl', 'usdr'],
  ...
  stablecoin: ['usdtToUSDC', 'stablecoin', 'realToUSDC', 'usdl', 'usdr'],
