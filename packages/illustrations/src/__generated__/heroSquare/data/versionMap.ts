...
const versionMap: Record<HeroSquareName, number> = {
  ...
  test: 0,
  borrowCoinsBtc: 1,
  instoSecurityKeyAuth: 1,
  instoEarnGlobe: 1,
  instoGovernance: 1,
  instoEthStakingUpsell: 1,
  instoWalletSecurity: 1,
  instoStakingMissedReturns: 2,
  instoRequestSent: 2,
  instoSecurityKey: 0,
  instoOnChain: 3,
  instoPhoneUnknown: 1,
  cryptoPortfolioUsdc: 1,
  instoCoinbaseOneProtectedCrypto: 1,
  instoDocumentSuccess: 2,
  instoWeb3MobileSetupStart: 1,
  instoAddBankAccount: 1,
  instoWallet: 1,
  instoKeyGenerationPending: 1,
  instoEthStakingRewards: 1,
  tradingPerpetualsUsdc: 1,
  instoPrivateKey: 2,
  instoPrimeStaking: 1,
  instoStaking: 1,
  instoOpenEmail: 2,
  instoKeyGenerationComplete: 2,
  instoAdd2Fa: 1,
  instoEnableBiometrics: 1,
  flipStable: 0,
  cbmega: 0,
  genniusLaunch: 0,
  ship: 1,
