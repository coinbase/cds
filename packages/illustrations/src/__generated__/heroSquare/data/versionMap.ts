...
const versionMap: Record<HeroSquareName, number> = {
  ...
  camera: 4,
  cardBoosted: 3,
  linkingYourWalletToYourCoinbaseAccount: 7,
  sidechain: 3,
  discardAssets: 5,
  cryptoWallet: 5,
  docError: 3,
  ...
  baseNetworkLarge: 0,
  baseEmptyLarge: 0,
  baseCoinNetworkLarge: 0,
  baseDecentralizationLarge: 0,
  basePeopleLarge: 0,
  basePaycoinLarge: 0,
  baseChartLarge: 0,
  baseMintNftLarge: 0,
  basePiechartLarge: 0,
  baseCoinCryptoLarge: 0,
  baseCheck: 1,
  baseErrorLarge: 1,
  baseSecurityLarge: 0,
  baseNftLarge: 0,
