...
const descriptionMap: Record<string, string[]> = {
  btc: ['btcOneHundred', 'bitcoin', 'winBTC', 'bitcoinRewards'],
  ...
  Currency: ['bigBtcSend'],
  Crypto: ['bigBtcSend'],
  Bitcoin: ['bigBtcSend', 'lightningNetworkSend'],
  BTC: ['bigBtcSend'],
  store: ['bigBtcSend'],
  value: ['bigBtcSend', 'apyInterest', 'stableCoinMetaphor', 'riskStaking'],
  money: [
    'bigBtcSend',
    'sellSendAnytime',
    'lowFees',
  ...
  asset: ['bigBtcSend', 'assetManagementNavigation', 'ethStakingChart', 'ethRewards', 'ethToken'],
  sparkles: ['bigBtcSend', 'mintedNft', 'bitcoinRewards'],
  stars: ['bigBtcSend', 'ethStakingRewards', 'usdcLoan', 'leadGraph'],
  '✨': [
    'bigBtcSend',
    'noNftFound',
    'gem',
