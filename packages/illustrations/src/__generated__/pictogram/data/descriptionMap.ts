...
const descriptionMap: Record<string, string[]> = {
  ...
  '⚠️': ['idError', 'idBlock', 'cardDeclined', 'walletWarning', 'walletError'],
  error: ['idError', 'idBlock', 'calendarCaution', 'warning', 'outage'],
  confirmation: ['idError', 'idBlock', 'checkmark', 'done'],
  bad: ['idError', 'idBlock'],
  '': [
