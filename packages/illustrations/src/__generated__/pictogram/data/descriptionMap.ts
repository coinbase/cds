...
const descriptionMap: Record<string, string[]> = {
  ...
  time: ['waitingForConsensus', 'fast', 'waiting', 'clock', 'planet', 'options'],
  ...
  hour: ['waitingForConsensus', 'clock', 'options'],
  ...
  monitor: ['reviewAndAdd', 'pluginBrowser', 'priceTracking', 'instoBrowserMultiPlatform'],
  ...
  date: ['calendar', 'recurringPurchases', 'startToday', 'calendarHighlight', 'options'],
  ...
  contract: ['formDownload', 'bitcoinWhitePaper', 'commerceInvoice', 'commerceCheckout', 'options'],
  ...
  glass: ['notificationHubAnalysis', 'options'],
  ...
  icon: ['complianceNavigation', 'coinbaseOneProductIcon', 'options'],
