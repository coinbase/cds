...
const descriptionMap: Record<string, string[]> = {
  ...
  icon: ['options', 'complianceNavigation', 'coinbaseOneProductIcon'],
  options: ['options'],
  hourglass: ['options'],
  hour: ['options', 'waitingForConsensus', 'clock'],
  glass: ['options', 'notificationHubAnalysis'],
  time: ['options', 'waitingForConsensus', 'fast', 'waiting', 'clock', 'planet'],
  crypto: [
    'options',
    'stacking',
    'crypto101',
  ...
  contract: ['options', 'formDownload', 'bitcoinWhitePaper', 'commerceInvoice', 'commerceCheckout'],
  expire: ['options'],
  expiration: ['options'],
  target: ['options'],
  date: ['options', 'calendar', 'recurringPurchases', 'startToday', 'calendarHighlight'],
  '': [
