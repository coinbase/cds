...
const versionMap: Record<PictogramName, number> = {
  ...
  download: 1,
  instoEarnCoins: 1,
  instoAdvancedTradingRebates: 1,
  instoRiskStaking: 1,
  instoWalletWarning: 1,
  instoDecentralizationEverything: 1,
  instoNftLibrary: 1,
  instoGem: 1,
  instoEthStakingChart: 1,
  instoStakingGraph: 1,
  instoAccount: 1,
  instoDecentralizedExchange: 2,
  instoSelfCustodyWallet: 0,
  instoTrading: 1,
  instoKey: 1,
  instoBorrowingLending: 1,
  instoEarnGraph: 1,
  instoRestaking: 3,
  instoPasswordWalletLocked: 1,
  instoEth: 0,
  instoEthRewards: 1,
  instoAddressBook: 0,
  instoDelegate: 0,
  instoCrypto101: 1,
  instoDecentralizedWeb3: 2,
  instoCoinbaseOneShield: 0,
  instoApyInterest: 3,
  instoAuthenticatorProgress: 1,
  instoprimeMobileApp: 0,
  instoFiat: 1,
  instoMonitoringPerformance: 1,
  instoGlobalConnections: 1,
  instoCoinFocus: 1,
  instoEasyToUse: 1,
  instoSecuredAssets: 1,
  instoBorrowCoins: 1,
  inrTrade: 0,
};
