...
import { NumberTicker } from '../../typography/NumberTicker';
import { Text } from '../../typography/Text';
import { ProgressBar } from '../../visualizations/ProgressBar';
import { DefaultNumberTickerNodeSection } from '../NumberTicker/DefaultNumberTickerNodeSection';
...
const Format = () => {
  ...
  return (
    <VStack gap={2}>
      ...
      <NumberTicker font="display3" format={{ useGrouping: false }} value={value} />
      <Button onPress={onNext}>Next</Button>
    </VStack>
  );
};
...
const SubscriptionPriceExample = () => {
  ...
  return (
    <VStack gap={1}>
      <NumberTicker
        colorPulseOnUpdate
        NumberTickerNodeSectionComponent={(props) => (
          <DefaultNumberTickerNodeSection {...props} textProps={{ font: 'title1' }} />
        )}
...
export default NumberTickerScreen;
