...
import type { SelectOptionComponent, SelectType } from './Select';

const DefaultSelectOptionBase = <Type extends SelectType, T extends string = string>({
  value,
  label,
  onPress,
  disabled,
...
export const DefaultSelectOption = memo(DefaultSelectOptionBase) as SelectOptionComponent;
