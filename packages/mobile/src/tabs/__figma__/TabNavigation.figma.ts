...
// source=packages/mobile/src/tabs/Tabs.tsx
// component=Tabs
import figma from 'figma';

const instance = figma.selectedInstance;

// 'overflow' BOOLEAN — whether tabs overflow with scroll; handled automatically by Tabs, no direct prop
...
/>`,
  imports: ['import { Tabs } from "@coinbase/cds-mobile/tabs"'],
  id: 'tab-navigation-mobile',
