...
export const TabLabel = memo((_props: TabLabelProps) => {
  const mergedProps = useComponentConfig('TabLabel', _props);
  const { active, variant = 'primary', count = 0, max, ...props } = mergedProps;
