/**
 * @deprecated This component is deprecated. Please use the alpha `DataCard` from `@cbhq/cds-mobile/alpha/data-card` instead.
 *
 * ### Migration Guide
 *
 ...
 * **After:**
 * ```jsx
 * import { DataCard } from '@cbhq/cds-mobile/alpha/data-card';
 *
 * <DataCard
 *   title="Progress"
