...
export type MessagingCardBaseProps = MessagingCardLayoutProps & Omit<CardRootProps, 'children'>;
...
export const MessagingCard = memo(
  forwardRef<View, MessagingCardProps>((_props, ref) => {
    const {
      type,
      title,
      description,
      ...
      ...props
    } = useComponentConfig('MessagingCard', _props);
