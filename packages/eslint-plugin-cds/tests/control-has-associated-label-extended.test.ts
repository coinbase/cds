...
const validModalHeaderWithTitle = `
  import { ModalHeader } from '@cbhq/cds-web';
  const Component = () => {
    return (
...
const validComboboxWithRequiredA11yProps = `
  import { Combobox } from '@cbhq/cds-web';
...
const validTableWithCaption = `
  import { Table, TableCaption } from '@cbhq/cds-web';
  const Component = () => {
    return (
      <Table>
...
ruleTester.run('control-has-associated-label-extended', rule, {
  ...
  invalid: [
    ...
    {
      code: normalizeIndent`
        import { SegmentedTabs } from '@cbhq/cds-web';
...
`,
    ...
    {
      code: normalizeIndent`
        import { Table } from '@cbhq/cds-web';
        const Component = () => {
          return (
            <Table>
              <tbody />
