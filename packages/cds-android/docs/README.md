...
Component APIs (`Button`, future composables) are documented in **KDoc** on the public types — this
folder covers cross-cutting package guides only. For the internal rationale behind the token
