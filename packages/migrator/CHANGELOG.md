...
<sub>Release entries above are generated by `nx release` from version plans. See the [NPM registry](https://www.npmjs.com/package/@coinbase/cds-migrator) for published versions. `@coinbase/cds-migrator` adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).</sub>
