...
- **`packages/web-visualization/`** - Web visualization components built with D3 (`@cbhq/cds-web-visualization`)
- **`packages/mobile-visualization/`** - Mobile visualization components built with D3 and react-native-skia (`@cbhq/cds-mobile-visualization`)
